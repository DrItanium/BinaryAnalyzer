...
(defclass File (is-a MetadataTag)
 ...
 (message-handler .ReadLittleEndianInt)
 (message-handler .ReadBigEndianInt))
...
(defmessage-handler File .ReadLittleEndianInt ()
 (bind ?result (send ?self .ReadSeveralChars 4))
 (return (+ (nth$ 1 ?result)
			 (* 256 (nth$ 2 ?result))
			 (* 256 256 (nth$ 3 ?result))
			 (* 256 256 256 (nth$ 4 ?result)))))

(defmessage-handler File .ReadBigEndianInt ()
 (bind ?result (send ?self .ReadSeveralChars 4))
 (return (+ (nth$ 4 ?result)
			 (* 256 (nth$ 3 ?result))
			 (* 256 256 (nth$ 2 ?result))
			 (* 256 256 256 (nth$ 1 ?result)))))
